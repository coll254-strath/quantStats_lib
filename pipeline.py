## Consolidated Quant Analysis Pipeline
## This section consolidates the entire 5-stage quant equity research workflow into a single, executable Python cell. 
  # It fetches price data and fundamentals, structures returns, computes risk/return metrics, benchmarks against SPY, and visualizes the results.
